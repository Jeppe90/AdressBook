...
import {HomeScreen, ContactScreenDetail, SettingsScreen, SettingsScreenDetail} from './src/tab'
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused }) => {
          ...
          if (route.name === "Home") {
            iconName = focused
              ? IMAGE.ICON_HOME
              : IMAGE.ICON_BLACK_HOME;
          } else if (route.name === "Settings") {
            iconName = focused
              ? IMAGE.ICON_SETTING
              : IMAGE.ICON_BLACK_SETTING;
          }
